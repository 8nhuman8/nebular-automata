...
if __name__ == '__main__':
    ...
    parser.add_argument('-mc', '--max-count', metavar='MC', type=int, help='The maximum number of squares in the image. By default, this is half of all pixels in the future image.')
    ...
    parser.add_argument('-fp', '--find-percent', metavar='FP', type=float, help='The program will work until a nebula is filled with a certain percentage.')
