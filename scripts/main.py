...
if __name__ == '__main__':
    ...
    parser.add_argument('-ca1', '--color-accent1', metavar=('R', 'G', 'B', 'A'), nargs=4, type=int, default=(255, 29, 119, 255), help='The first or (primary if multicolor mode is not enabled) color of squares. Color components must be specified between 0 and 255.')
    parser.add_argument('-ca2', '--color-accent2', metavar=('R', 'G', 'B', 'A'), nargs=4, type=int, default=(0, 255, 255, 255), help='The second color of squares if multicolor mode is enabled. Color components must be specified between 0 and 255.')
    parser.add_argument('-cb', '--color-background', metavar=('R', 'G', 'B', 'A'), nargs=4, type=int, default=(255, 255, 255, 255), help='The background color. Color components must be specified between 0 and 255.')
