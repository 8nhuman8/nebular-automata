...
if __name__ == '__main__':
    ...
    parser.add_argument('-ca', '--color-accent', metavar=('R', 'G', 'B'), nargs=3, type=int, default=(255, 29, 119), help='The color of squares. Color components must be specified between 0 and 255.')
